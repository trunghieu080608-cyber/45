...
const options = {
  host: 'warvn.seedloaf.gg:49345', // Địa chỉ server
  port: 25565,           // Cổng kết nối mặc định
  username: 'admin247', // Tên bot
  version: '1.21.11',     // Phiên bản Minecraft
  language: 'vi_vn'      // Cấu hình ngôn ngữ tiếng Việt cho bot
}
